...
const DatabasePage = () => {
  ...
  const handleSendChat = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        const newChat = { input: query, response: response.data.data }
  ...
  const handleSendQuery = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        const newQuery = { input: query, response: response.data.queryResult }
  ...
  //         title: schemaKey,
  //         key: schemaKey,
  //         children: schema.map((table, index) => ({
  //           title: table.name,
  //           key: `${schemaKey}-${index}`,
  //           children: table.columns
  //             ? table.columns.map((col) => ({
  //                 title: col.name,
  //                 key: `${schemaKey}-${index}-${col.name}`,
  //               }))
  //             : [],
  //         })),
  //       }
